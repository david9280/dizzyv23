   ...
   <div class="i_modal_in_in"> 
       <div class="i_modal_content">  
            ...
            <div class="i_delete_post_description">
               <?php echo filter_var($LANG['sure_to_delete_post'], FILTER_SANITIZE_STRING) ;?>
            </div>
            <!--Modal Header-->
            <div class="i_modal_g_footer flex_">
                <div class="alertBtnRight delete_post transition" id="<?php echo filter_var($postID, FILTER_SANITIZE_STRING) ;?>"><?php echo filter_var($LANG['ok'], FILTER_SANITIZE_STRING) ;?></div>
