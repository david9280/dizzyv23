...
echo "cURL test: ".getDataFromUrl("http://www.google.com");

echo "<h2>Basic Requirements</h2>";
if (phpversion() < 5.5) {
	echo '<div class="msg-warning">Error: Your PHP version is lower than 5.5+ (You are using: ' . phpversion() . ' )</div>';
	echo '<div>To ensure your security, we recommend that you use a version higher than 5.5.</div>';
	$error++;
} else {
