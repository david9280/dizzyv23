<?php
    ...
    *-------------------------------------------------------- */
    ...
    if (!function_exists('getConfig')) {
        ...
        {
            try {
                if (! @include_once(INORA_METHODS_CONFIG)) {
                    throw new Exception ('file does not exist');
                } else {
                    return require INORA_METHODS_CONFIG;
                }
            } catch (\Exception $e) {
                throw new \Exception("INORA_METHODS_CONFIG - Missing config path constant", 1);                
            }
        }
    }
    ...
    if (!function_exists('configItem')) {
        ...
        {
            $getConfig  = getConfig();
            $getItem    = $getConfig['inoraPaymentConfig'];
            return $getItem;
        }
    }
    ...
    if (!function_exists('configItemData')) {
        ...
        {
            $getConfig  = getConfig();
            $data    = $getConfig['inoraPaymentConfig'];
    ...
    if (!function_exists('getPublicConfigItem')) {
        ...
        {
            $getConfig  = getConfig();
            $getItem    = $getConfig['inoraPaymentConfig']['payments']['gateway_configuration'];
    ...
    if (!function_exists('getAppUrl')) {
        ...
        {    
            ...
            $basePath = $configData['inoraPaymentConfig']['base_url'];
