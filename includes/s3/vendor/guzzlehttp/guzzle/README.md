...
echo isset($response->getStatusCode()) ? $response->getStatusCode() : NULL; // 200
echo isset($response->getHeaderLine('content-type')) ? $response->getHeaderLine('content-type'): NULL; // 'application/json; charset=utf8'
echo isset($response->getBody()) ? $response->getBody() : NULL; // '{"id": 1420053, "name": "guzzle", ...}'
