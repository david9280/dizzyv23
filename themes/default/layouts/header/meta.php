...
<?php if($logedIn == '1'){ ?>
<link rel="manifest" href="<?php echo filter_var($base_url, FILTER_VALIDATE_URL);?>src/manifest.json">
<?php }?>
<link rel="apple-touch-icon" href="<?php echo filter_var($base_url, FILTER_VALIDATE_URL);?>src/192x192.png">