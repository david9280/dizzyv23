<?php 
    ...
    ?>
          <!--MESSAGE-->
          <div class="i_notification_wrpper mor body_<?php echo filter_var($notificationID, FILTER_SANITIZE_STRING);?>" id="<?php echo filter_var($notificationID, FILTER_SANITIZE_STRING);?>" data-last="<?php echo filter_var($notificationID, FILTER_SANITIZE_STRING);?>">
            <a href="<?php echo filter_var($notUrl, FILTER_SANITIZE_STRING);?>">
            ...
            <div class="i_message_setting msg_Set_<?php echo filter_var($notificationID, FILTER_SANITIZE_STRING);?> msg_Set" id="<?php echo filter_var($notificationID, FILTER_SANITIZE_STRING);?>">
