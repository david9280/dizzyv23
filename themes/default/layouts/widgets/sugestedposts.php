<div class="i_post_suggests">
    <div class="i_post_suggest_title">
        <?php echo preg_replace( '/{.*?}/', "<a href='".$base_url.$userPostOwnerUsername."'>".$userPostOwnerUserFullName."</a>", $LANG['suggest_post_title']);?>
    </div>
    <div class="i_posts_suggestions_container">
      ...
      ?>
        <div class="i_suggested_post_file"
